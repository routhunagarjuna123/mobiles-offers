...
import offers.reader.mycomponent.MyStreamReaderImpl
import offers.transformer.mycomponent.MyStreamTransformerImpl
import offers.writer.mycomponent.MyStreamWriterImpl
